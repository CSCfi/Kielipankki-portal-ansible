...
if ( have_posts() ) {
     	echo "<h1 class=\"first\">News</h1><hr/>";
	while ( have_posts() ) {
		the_post(); 
...
<!-- Pagination -->
	...
	<table>
	<tr>
	<td class="left"><?php next_posts_link( '< Older news' ); ?></td>
	<td class="right"><?php previous_posts_link( 'Newer news >' ); ?></td>
	</tr>
	</table>
